...
| $\sqsupseteq$ | `\sqsupseteq` | $\measuredangle$  | `\measuredangle`  |
...
| **Symbol** | **Script**         | **Symbol** | **Script**  |
| ---------- | ------------------ | ---------- | ----------- |
| $\pm$      | `\diamond`         | $\cap$     | `\oplus`    |
| $\mp$      | `\bigtriangleup`   | $\cup$     | `\ominus`   |
| $\times$   | `\bigtriangledown` | $\uplus$   | `\otimes`   |
| $\div$     | `\triangleleft`    | $\sqcap$   | `\oslash`   |
| $\ast$     | `\triangleright`   | $\sqcup$   | `\odot`     |
| $\star$    | `\bigcirc`         | $\vee$     | `\circ`     |
| $\dagger$  | `\bullet`          | $\wedge$   | `\setminus` |
| $\ddagger$ | `\wr`              | $\cdot$    | `\amalg`    |
...
| **Symbol**        | **Script**                            | **Symbol**     | **Script**   |
| ----------------- | ------------------------------------- | -------------- | ------------ |
| $ | $ or $ \mid $ | `|` or `\mid` (difference in spacing) | $/$            | `/`          |
| $\{$              | \{                                    | $ \langle $    | `\langle`    |
